...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.1/docs/resources/enablement
...
export class Enablement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Enablement that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.1/docs/resources/enablement#import import section} in the documentation of this resource for the id to use
