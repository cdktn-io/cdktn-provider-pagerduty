...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/incident_type_custom_field
...
export class DataPagerdutyIncidentTypeCustomField extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyIncidentTypeCustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/incident_type_custom_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/incident_type_custom_field pagerduty_incident_type_custom_field} Data Source
  *
  * @param scope The scope in which to define this construct
