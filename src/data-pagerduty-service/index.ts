...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/service
...
export interface DataPagerdutyServiceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataPagerdutyServiceTeamsOutputReference extends cdktn.ComplexObject {
...
export class DataPagerdutyServiceTeamsList extends cdktn.ComplexList {
...
*/
export class DataPagerdutyService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyService that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/service pagerduty_service} Data Source
  *
  * @param scope The scope in which to define this construct
