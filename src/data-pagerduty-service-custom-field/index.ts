...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/data-sources/service_custom_field
...
export class DataPagerdutyServiceCustomField extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyServiceCustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/data-sources/service_custom_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/data-sources/service_custom_field pagerduty_service_custom_field} Data Source
  *
  * @param scope The scope in which to define this construct
