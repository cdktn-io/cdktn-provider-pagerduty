...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service_integration
...
export class ServiceIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service_integration pagerduty_service_integration} Resource
  *
  * @param scope The scope in which to define this construct
