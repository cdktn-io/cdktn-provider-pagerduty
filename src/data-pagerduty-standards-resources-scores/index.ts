...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/data-sources/standards_resources_scores
...
export class DataPagerdutyStandardsResourcesScores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyStandardsResourcesScores that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/data-sources/standards_resources_scores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/data-sources/standards_resources_scores pagerduty_standards_resources_scores} Data Source
  *
  * @param scope The scope in which to define this construct
