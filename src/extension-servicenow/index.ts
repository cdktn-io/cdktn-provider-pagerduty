...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/extension_servicenow
...
*/
export class ExtensionServicenow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtensionServicenow that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/extension_servicenow#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "pagerduty_extension_servicenow", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/extension_servicenow pagerduty_extension_servicenow} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      referer: cdktn.stringToTerraform(this._referer),
      snow_password: cdktn.stringToTerraform(this._snowPassword),
      snow_user: cdktn.stringToTerraform(this._snowUser),
      summary: cdktn.stringToTerraform(this._summary),
      sync_options: cdktn.stringToTerraform(this._syncOptions),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      referer: {
        value: cdktn.stringToHclTerraform(this._referer),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      snow_password: {
        value: cdktn.stringToHclTerraform(this._snowPassword),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      snow_user: {
        value: cdktn.stringToHclTerraform(this._snowUser),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      sync_options: {
        value: cdktn.stringToHclTerraform(this._syncOptions),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
