...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service
...
export class Service extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Service that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/service pagerduty_service} Resource
  *
  * @param scope The scope in which to define this construct
