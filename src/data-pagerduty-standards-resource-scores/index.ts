...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/data-sources/standards_resource_scores
...
export class DataPagerdutyStandardsResourceScores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyStandardsResourceScores that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/data-sources/standards_resource_scores#import import section} in the documentation of this resource for the id to use
