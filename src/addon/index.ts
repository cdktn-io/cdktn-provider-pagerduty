...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/addon
...
export class Addon extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Addon that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/addon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/addon pagerduty_addon} Resource
  *
  * @param scope The scope in which to define this construct
