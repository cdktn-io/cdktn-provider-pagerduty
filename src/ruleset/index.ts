...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/ruleset
...
export class Ruleset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ruleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/ruleset#import import section} in the documentation of this resource for the id to use
