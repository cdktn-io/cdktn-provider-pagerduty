...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/resources/ruleset
...
export class RulesetTeamOutputReference extends cdktn.ComplexObject {
...
export class Ruleset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ruleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/resources/ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/resources/ruleset pagerduty_ruleset} Resource
  *
  * @param scope The scope in which to define this construct
