...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/event_orchestrations
...
export class DataPagerdutyEventOrchestrations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/event_orchestrations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/event_orchestrations pagerduty_event_orchestrations} Data Source
  *
  * @param scope The scope in which to define this construct
