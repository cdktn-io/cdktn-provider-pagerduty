...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/service_dependency
...
export class ServiceDependency extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDependency that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/service_dependency#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/service_dependency pagerduty_service_dependency} Resource
  *
  * @param scope The scope in which to define this construct
