...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/escalation_policy
...
export class DataPagerdutyEscalationPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEscalationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/escalation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/escalation_policy pagerduty_escalation_policy} Data Source
  *
  * @param scope The scope in which to define this construct
