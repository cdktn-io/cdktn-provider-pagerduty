...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs
...
export class PagerdutyProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing PagerdutyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs pagerduty} Resource
  *
  * @param scope The scope in which to define this construct
