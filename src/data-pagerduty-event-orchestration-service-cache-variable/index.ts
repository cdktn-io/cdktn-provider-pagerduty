...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/event_orchestration_service_cache_variable
...
export class DataPagerdutyEventOrchestrationServiceCacheVariable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestrationServiceCacheVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/event_orchestration_service_cache_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/data-sources/event_orchestration_service_cache_variable pagerduty_event_orchestration_service_cache_variable} Data Source
  *
  * @param scope The scope in which to define this construct
