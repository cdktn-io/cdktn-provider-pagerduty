...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/alert_grouping_setting
...
export class AlertGroupingSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertGroupingSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/alert_grouping_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/alert_grouping_setting pagerduty_alert_grouping_setting} Resource
  *
  * @param scope The scope in which to define this construct
