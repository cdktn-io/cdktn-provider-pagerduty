...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/jira_cloud_account_mapping
...
export class DataPagerdutyJiraCloudAccountMapping extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyJiraCloudAccountMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/jira_cloud_account_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.4/docs/data-sources/jira_cloud_account_mapping pagerduty_jira_cloud_account_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
