...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/data-sources/incident_type
...
export class DataPagerdutyIncidentType extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyIncidentType that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/data-sources/incident_type#import import section} in the documentation of this resource for the id to use
