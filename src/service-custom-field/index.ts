...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/resources/service_custom_field
...
export class ServiceCustomField extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceCustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/resources/service_custom_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.35.0/docs/resources/service_custom_field pagerduty_service_custom_field} Resource
  *
  * @param scope The scope in which to define this construct
