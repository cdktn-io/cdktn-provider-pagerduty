...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/data-sources/service_custom_field_value
...
export class DataPagerdutyServiceCustomFieldValue extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyServiceCustomFieldValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.2/docs/data-sources/service_custom_field_value#import import section} in the documentation of this resource for the id to use
