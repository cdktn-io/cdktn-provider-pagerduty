...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/tag_assignment
...
export class TagAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/tag_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/tag_assignment pagerduty_tag_assignment} Resource
  *
  * @param scope The scope in which to define this construct
