...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/event_rule
...
*/
export class EventRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/event_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EventRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "pagerduty_event_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/resources/event_rule pagerduty_event_rule} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      action_json: cdktn.stringToTerraform(this._actionJson),
      advanced_condition_json: cdktn.stringToTerraform(this._advancedConditionJson),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      action_json: {
        value: cdktn.stringToHclTerraform(this._actionJson),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      advanced_condition_json: {
        value: cdktn.stringToHclTerraform(this._advancedConditionJson),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
