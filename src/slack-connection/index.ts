...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/slack_connection
...
export class SlackConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SlackConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/slack_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/resources/slack_connection pagerduty_slack_connection} Resource
  *
  * @param scope The scope in which to define this construct
