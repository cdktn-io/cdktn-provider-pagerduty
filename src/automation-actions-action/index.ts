...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/automation_actions_action
...
export class AutomationActionsAction extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationActionsAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/automation_actions_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.34.0/docs/resources/automation_actions_action pagerduty_automation_actions_action} Resource
  *
  * @param scope The scope in which to define this construct
