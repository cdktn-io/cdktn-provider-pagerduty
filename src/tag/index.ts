...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/resources/tag
...
export class Tag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Tag that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.3/docs/resources/tag#import import section} in the documentation of this resource for the id to use
