...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/schedulev2
...
export class DataPagerdutySchedulev2 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutySchedulev2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/schedulev2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/schedulev2 pagerduty_schedulev2} Data Source
  *
  * @param scope The scope in which to define this construct
