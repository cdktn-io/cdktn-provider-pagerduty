...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/licenses
...
export interface DataPagerdutyLicensesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataPagerdutyLicensesLicensesOutputReference extends cdktn.ComplexObject {
...
export class DataPagerdutyLicensesLicensesList extends cdktn.ComplexList {
...
*/
export class DataPagerdutyLicenses extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyLicenses that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/licenses#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "pagerduty_licenses", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/licenses pagerduty_licenses} Data Source
  *
  * @param scope The scope in which to define this construct
