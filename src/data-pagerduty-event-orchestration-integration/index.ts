...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/event_orchestration_integration
...
export interface DataPagerdutyEventOrchestrationIntegrationAConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataPagerdutyEventOrchestrationIntegrationParametersAOutputReference extends cdktn.ComplexObject {
...
export class DataPagerdutyEventOrchestrationIntegrationParametersAList extends cdktn.ComplexList {
...
*/
export class DataPagerdutyEventOrchestrationIntegrationA extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestrationIntegrationA that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/event_orchestration_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "pagerduty_event_orchestration_integration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.0/docs/data-sources/event_orchestration_integration pagerduty_event_orchestration_integration} Data Source
  *
  * @param scope The scope in which to define this construct
