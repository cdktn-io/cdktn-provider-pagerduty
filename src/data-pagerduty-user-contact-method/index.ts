...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.0/docs/data-sources/user_contact_method
...
export class DataPagerdutyUserContactMethod extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyUserContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.31.0/docs/data-sources/user_contact_method#import import section} in the documentation of this resource for the id to use
