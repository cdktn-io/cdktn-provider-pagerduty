...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/data-sources/users
...
export class DataPagerdutyUsers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/data-sources/users pagerduty_users} Data Source
  *
  * @param scope The scope in which to define this construct
