...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/automation_actions_action
...
export class DataPagerdutyAutomationActionsAction extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyAutomationActionsAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/automation_actions_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.1/docs/data-sources/automation_actions_action pagerduty_automation_actions_action} Data Source
  *
  * @param scope The scope in which to define this construct
