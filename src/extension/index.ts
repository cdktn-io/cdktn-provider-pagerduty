...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/extension
...
export class Extension extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Extension that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/extension#import import section} in the documentation of this resource for the id to use
