...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/user_notification_rule
...
export class UserNotificationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UserNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/user_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/user_notification_rule pagerduty_user_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
