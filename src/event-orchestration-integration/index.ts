...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/event_orchestration_integration
...
export class EventOrchestrationIntegrationA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventOrchestrationIntegrationA that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/event_orchestration_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.36.0/docs/resources/event_orchestration_integration pagerduty_event_orchestration_integration} Resource
  *
  * @param scope The scope in which to define this construct
