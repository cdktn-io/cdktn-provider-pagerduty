...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/response_play
...
export class ResponsePlay extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ResponsePlay that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.3/docs/resources/response_play#import import section} in the documentation of this resource for the id to use
