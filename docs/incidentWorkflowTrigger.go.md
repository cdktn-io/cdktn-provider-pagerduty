...
```go
import "github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v17/incidentworkflowtrigger"
...
&incidentworkflowtrigger.IncidentWorkflowTriggerConfig {
	...
	Condition: *string,
	Id: *string,
	Permissions: github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v17.incidentWorkflowTrigger.IncidentWorkflowTriggerPermissions,
	Services: *[]*string,
}
```
