...
```go
import "github.com/cdktn-io/cdktn-provider-pagerduty-go/pagerduty/v16/tag"
...
| <code><a href="#@cdktn/provider-pagerduty.tag.TagConfig.property.label">Label</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.33.0/docs/resources/tag#label Tag#label}. |
