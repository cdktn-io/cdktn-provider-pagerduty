...
| <code><a href="#@cdktn/provider-pagerduty.dataPagerdutySchedule.DataPagerdutyScheduleConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.32.2/docs/data-sources/schedule#name DataPagerdutySchedule#name}. |
